...
export const translations = {
  'zh-CN': {
    ...
    hasAccount: '已有账户？登录',
    // Aggregator
    aggregatorTitle: '订阅聚合管理',
    aggregatorDesc: '将多个节点源和机场订阅合并，生成稳定的订阅链接，支持定期自动刷新',
    newAggregator: '新建聚合',
    editAggregator: '编辑聚合',
    deleteAggregator: '删除',
    saveAggregator: '保存',
    saving: '保存中...',
    aggregatorName: '聚合名称',
    aggregatorNamePlaceholder: '例如：我的节点聚合',
    directNodes: '直接节点',
    directNodesDesc: '直接粘贴节点 URI（每行一个）',
    directNodesPlaceholder: '粘贴节点链接，每行一个\nvless://...\nvmess://...',
    directNodesPrefix: '节点前缀',
    directNodesPrefixPlaceholder: '例如：自建',
    directNodeGroupName: '分组名称',
    directNodeGroupNamePlaceholder: '例如：自建节点',
    addDirectNodeGroup: '添加直接节点分组',
    airportSources: '机场订阅源',
    airportSourcesDesc: '每个机场可单独配置前缀',
    addAirportSource: '添加机场',
    airportUrl: '订阅地址',
    airportUrlPlaceholder: 'https://...',
    airportPrefix: '节点前缀',
    airportPrefixPlaceholder: '例如：机场A',
    airportName: '备注名称',
    airportNamePlaceholder: '可选备注',
    airportUserAgent: 'User-Agent',
    airportUserAgentPlaceholder: '例如：clash.meta / ClashforWindows / Shadowrocket',
    airportUserAgentHint: '留空则使用请求客户端的 User-Agent；部分订阅源会根据 UA 返回不同节点。',
    customHttpsPortWarning: 'Cloudflare Workers 发布后会忽略 HTTPS 自定义端口；请改用 443 或反代域名。',
    moveUp: '上移',
    moveDown: '下移',
    removeSource: '删除',
    refreshInterval: '自动刷新间隔',
    refreshIntervalUnit: '秒',
    refreshIntervalHint: '节点缓存过期后自动重新拉取（建议 3600 秒）',
    manualRefresh: '立即刷新',
    refreshing: '刷新中...',
    refreshSuccess: '刷新成功',
    outputLinks: '输出订阅链接',
    outputLinksDesc: '以下链接可直接导入代理客户端，节点会按配置的间隔自动更新',
    lastRefresh: '上次刷新',
    never: '从未',
    cachedProxies: '已缓存节点',
    noAggregators: '还没有聚合，点击"新建聚合"开始',
    confirmDeleteAggregator: '确定要删除此聚合吗？',
    backToList: '返回列表',
    aggregatorSaved: '聚合保存成功',
    aggregatorDeleted: '聚合已删除',
    aggregatorPage: '订阅聚合'
  },
  'en-US': {
    ...
    // Aggregator
    aggregatorTitle: 'Subscription Aggregator',
    aggregatorDesc: 'Combine multiple proxy sources and airport subscriptions into stable links with auto-refresh',
    newAggregator: 'New Aggregator',
    editAggregator: 'Edit Aggregator',
    deleteAggregator: 'Delete',
    saveAggregator: 'Save',
    saving: 'Saving...',
    aggregatorName: 'Name',
    aggregatorNamePlaceholder: 'e.g. My Aggregator',
    directNodes: 'Direct Nodes',
    directNodesDesc: 'Paste proxy URIs directly (one per line)',
    directNodesPlaceholder: 'Paste proxy URIs, one per line\nvless://...\nvmess://...',
    directNodesPrefix: 'Node Prefix',
    directNodesPrefixPlaceholder: 'e.g. Self',
    directNodeGroupName: 'Group Name',
    directNodeGroupNamePlaceholder: 'e.g. Self-hosted',
    addDirectNodeGroup: 'Add Direct Group',
    airportSources: 'Airport Subscriptions',
    airportSourcesDesc: 'Each airport can have its own prefix',
    addAirportSource: 'Add Airport',
    airportUrl: 'Subscription URL',
    airportUrlPlaceholder: 'https://...',
    airportPrefix: 'Node Prefix',
    airportPrefixPlaceholder: 'e.g. AirportA',
    airportName: 'Label',
    airportNamePlaceholder: 'Optional label',
    airportUserAgent: 'User-Agent',
    airportUserAgentPlaceholder: 'e.g. clash.meta / ClashforWindows / Shadowrocket',
    airportUserAgentHint: 'Leave empty to use the request User-Agent. Some providers return different nodes by UA.',
    customHttpsPortWarning: 'Published Cloudflare Workers ignore custom HTTPS ports. Use 443 or a reverse-proxy domain.',
    moveUp: 'Move up',
    moveDown: 'Move down',
    removeSource: 'Remove',
    refreshInterval: 'Auto Refresh Interval',
    refreshIntervalUnit: 'seconds',
    refreshIntervalHint: 'Nodes are re-fetched when cache expires (recommended: 3600s)',
    manualRefresh: 'Refresh Now',
    refreshing: 'Refreshing...',
    refreshSuccess: 'Refresh successful',
    outputLinks: 'Output Subscription Links',
    outputLinksDesc: 'Import these links into your proxy client. Nodes update automatically.',
    lastRefresh: 'Last Refresh',
    never: 'Never',
    cachedProxies: 'Cached Nodes',
    noAggregators: 'No aggregators yet. Click "New Aggregator" to start.',
    confirmDeleteAggregator: 'Delete this aggregator?',
    backToList: 'Back to List',
    aggregatorSaved: 'Aggregator saved',
    aggregatorDeleted: 'Aggregator deleted',
    aggregatorPage: 'Aggregator'
  },
  'fa': {
